...
```{r}
#getwd()
#setwd("/Users/caprinapugliese/Documents/School/Uconn/2024-26_Grad_School/2025-26_Year-2/popgen/labs/PopGen25/labs/data")
vcf = read.vcfR("muc19_subsample.vcf.gz")
GT = extract.gt(vcf,element="GT",as.numeric=TRUE)

t_vcf = read.vcfR("test_data.vcf")
...
```{r}
samples <- read_table("muc_samples.txt")
