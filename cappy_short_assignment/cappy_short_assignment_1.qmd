...
4.  Calculate all pairwise undefinedF_ST values for all pairs of samples.
    ...
    pops = sort(unique(samples$population)) #works
    ...
    # need to catagorize subpopulations
...
6.  [x] Work on your test data set

7.  [x] The test data should have at least 3 populations, and at least 40 sites.
